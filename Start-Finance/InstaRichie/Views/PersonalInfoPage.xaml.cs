...
namespace StartFinance.Views
{
    public sealed partial class PersonalInfoPage : Page
    {
        ...
        // Used to check DatePicker value as current version od SDK doesn't support empty value.
        private DateTime dateTimeOnPageCreation;
        ...
        private async void EditPersonalInfo_Click(object sender, RoutedEventArgs e)
        {
            ...
            DobDatePicker.Date = editData.DOB;
